...
# TimeLine:
  ...
  * 12-14-12-2017 - tried to contact msrc via email, tried to contact @krzywix - to get a conformation that the bug is indeed fixed so i can close it on my side, received no reply from msrc, @krzywix told me its not he's job and that "many people are fuzzing edge now".
